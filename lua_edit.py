...
class EditWindow(stc.StyledTextCtrl):
    ...
    def __config(self):
        ...
        self.SetKeyWords(0, " ".join(lua_kw.word))
        self.SetKeyWords(1, " ".join(lua_kw.word2))
        self.SetKeyWords(2, " ".join(lua_kw.word3))
        self.SetKeyWords(3, " ".join(lua_kw.word4))
        self.SetKeyWords(4, " ".join(promot_kw))
    ...
    def OnUpdateUI(self, event):
        ...
        and styleBefore == stc.STC_LUA_OPERATOR:
        ...
        if braceAtCaret < 0:
            ...
            and styleAfter == stc.STC_LUA_OPERATOR:
